...
|---|--------|-----|-------|-------------------------|
| 1.1 | Enable GitHub Pages via **Settings → Pages → Source: GitHub Actions** | Privacy policy must be live at `https://gthgomez.github.io/WallpaperCropFixer/PRIVACY.html` before the Play listing can be submitted (privacy policy URL is required for all apps) | GitHub repo → Settings → Pages | Privacy page source already in repo; URL format documented in PLAY_SUBMISSION_CHECKLIST.md |
